...
/*  //wire service is not working
  ...
  getAccountBrand(){
    ...
    .then(result =>{
        if(result){
          ...
          //console.log('Account Brand '+AccBrand)
          this.AccountBrand = AccBrand;
          console.log('The Account Brand is '+this.AccountBrand);
        }
    }).catch(error=>{
  ...
  ECPTranings(){
    getECPTrainings({accountId : this.receivedId})
      .then(response=>{
          //console.log('ECP Training =>'+JSON.stringify(response));
          if(response){
  ...
  navigateToRelatedList(relationshipName){
    ...
    handleTrainingChange(event){
      ...
      //console.log('Training Id = > '+this.selectedTrainingId);
    ...
    getAttendeeNums(){
      ...
      .then(response=>{
          if(response){
            ...
            //console.log('Attendee num '+this.NumOfAttendee);
    ...
    loadAttendees(){
      ...
      .then(response =>{
          if(response){
              console.log('Training Id =>'+JSON.stringify(this.selectedTrainingId));
