...
import MonthlyNetSales from '@salesforce/label/c.AccountMonthlyNetSales';
...
export default class TabStatisticsNetSales extends LightningElement {
    ...
    connectedCallback() {
        getLensesAnnualRevenue({recordId: this.receivedId,type : "Net"})
        .then(response => {
        ...
        .then(response => {
            ...
            for(let i=1; i<=12; i++){
                ...
                if(AllSalesDataCY[i] != undefined){
                    this.FramesCFYMap.push({value:AllSalesDataCY[i].framesNetSales,key:i}); 
                    this.InstrumentsCFYMap.push({value:AllSalesDataCY[i].instrumentsNetSales,key:i}); 
                    this.ContactLensCFYMap.push({value:AllSalesDataCY[i].contactLensNetSales,key:i}); 
                    this.OthersCFYMap.push({value:AllSalesDataCY[i].otherNetSales,key:i});
                    this.TotalSalesCFYMap.push({value:AllSalesDataCY[i].totalNetSales,key:i});
                    ...
                    totalFramesSalesCFY += AllSalesDataCY[i].framesNetSales;
                    totalInstrumentsSalesCFY += AllSalesDataCY[i].instrumentsNetSales;
                    totalContactLensSalesCFY += AllSalesDataCY[i].contactLensNetSales;
                    totalOthersSalesCFY += AllSalesDataCY[i].otherNetSales;
                    totalSalesCFY += AllSalesDataCY[i].totalNetSales;
                ...
                if(AllSalesDataLY[i] != undefined){
                    this.TotalSalesLFYMap.push({value:AllSalesDataLY[i].totalNetSales,key:i});
                    this.TotalQtyLFYMap.push({value:AllSalesDataLY[i].totalQty,key:i});
                    totalLFYSales += AllSalesDataLY[i].totalNetSales;
            ...
            if(forecastData != null){
                this.forecastCFY.push(forecastData.Budget_April_Current_Year__c != null ? forecastData.Budget_April_Current_Year__c : 0,forecastData.Budget_May_Current_Year__c != null ? forecastData.Budget_May_Current_Year__c : 0 ,forecastData.Budget_June_Current_Year__c != null ? forecastData.Budget_June_Current_Year__c : 0,forecastData.Budget_July_Current_Year__c != null ?forecastData.Budget_July_Current_Year__c : 0,forecastData.Budget_August_Current_Year__c != null ? forecastData.Budget_August_Current_Year__c : 0,
                    forecastData.Budget_September_Current_Year__c != null ? forecastData.Budget_September_Current_Year__c : 0 ,forecastData.Budget_October_Current_Year__c != null ?forecastData.Budget_October_Current_Year__c : 0,forecastData.Budget_November_Current_Year__c != null ?forecastData.Budget_November_Current_Year__c : 0 ,forecastData.Budget_December_Current_Year__c != null ? forecastData.Budget_December_Current_Year__c : 0,forecastData.Budget_January_Current_Year__c != null ? forecastData.Budget_January_Current_Year__c : 0,
                    forecastData.Budget_February_Current_Year__c != null ? forecastData.Budget_February_Current_Year__c : 0,forecastData.Budget_March_Current_Year__c != null ? forecastData.Budget_March_Current_Year__c : 0,forecastData.Forecast_current_year__c != null ? forecastData.Forecast_current_year__c : 0);
