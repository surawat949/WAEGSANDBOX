...
export default class TabMVCContactWorkingPlaces extends NavigationMixin(LightningElement) {
    ...
    columns =  [
        ...
        {label: Shipping_Address, fieldName: 'ShippingAddress', type: 'text', wrapText : true},
        ...
        getRelatedClinic(){
            getRelatedClinicsByContactId({contactId:this.receivedId}).then(result=>{
                if(result){
                    ...
                    if(this.data.length > 0){
                        ...
                        this.data.forEach(row=>{
                            ...
                            row.ShippingAddress = row.Account.ShippingStreet+' '+row.Account.ShippingCity,
                ...
                this.isLoading = false;
                this.errors = error;
                this.showToast('Error',JSON.stringify(this.errors),'Error');
            })
        }
